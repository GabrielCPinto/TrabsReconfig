...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone II" ENABLE_RUNTIME_MOD="NO" INIT_FILE="../Topo da hierarquia/program memory.mif" NUMWORDS_A=4096 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=14 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_0.init_file_layout = "port_a",
		ram_block1a_0.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_0.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_1.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_1.init_file_layout = "port_a",
		ram_block1a_1.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_1.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_2.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_2.init_file_layout = "port_a",
		ram_block1a_2.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_2.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_3.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_3.init_file_layout = "port_a",
		ram_block1a_3.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_3.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_4.init_file = "../Topo da hierarquia/program memory.mif",
	...
	defparam
		...
		ram_block1a_5.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_5.init_file_layout = "port_a",
		ram_block1a_5.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_5.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_6.init_file = "../Topo da hierarquia/program memory.mif",
	...
	defparam
		...
		ram_block1a_7.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_7.init_file_layout = "port_a",
		ram_block1a_7.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_7.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_8.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_8.init_file_layout = "port_a",
		ram_block1a_8.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_8.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_9.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_9.init_file_layout = "port_a",
		ram_block1a_9.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_9.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_10.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_10.init_file_layout = "port_a",
		ram_block1a_10.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_10.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_11.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_11.init_file_layout = "port_a",
		ram_block1a_11.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_11.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_12.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_12.init_file_layout = "port_a",
		ram_block1a_12.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_12.mem_init0 = 2048',
		ram_block1a_12.mem_init1 = 2048',
	...
	defparam
		...
		ram_block1a_13.init_file = "../Topo da hierarquia/program memory.mif",
		ram_block1a_13.init_file_layout = "port_a",
		ram_block1a_13.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_13.mem_init0 = 2048',
...
// Retrieval info: PRIVATE: MIFfilename STRING "../Topo da hierarquia/program memory.mif"
...
// Retrieval info: CONSTANT: INIT_FILE STRING "../Topo da hierarquia/program memory.mif"
...
// Retrieval info: GEN_FILE: TYPE_NORMAL Rom.tdf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Rom.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Rom.cmp TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Rom.bsf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Rom_inst.tdf FALSE
